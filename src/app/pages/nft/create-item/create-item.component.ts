...
export class CreateItemComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const collectionId = decodeURIComponent(this.itemObj.pagekey);
  ...
  onChanged(event: any) {
    ...
    const file_size = event.target.files[0].size / 720 / 720;
  ...
  onSubmit() {
    ...
    const add: any = this.service.metaDeatails.account;
    this.itemObj.caddress = this.service.metaDeatails.account;
